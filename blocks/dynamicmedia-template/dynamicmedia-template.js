...
export default async function decorate(block) {
  ...
  if(configSrc === 'inline'){
    ...
    //https://author-p153659-e1620914.adobeaemcloud.com/graphql/execute.json/luma3/DynamicMediaTemplateByPath;path=
    ...
    const CONFIG = {
      ...
      GRAPHQL_QUERY: '/graphql/execute.json/luma3/DynamicMediaTemplateByPath'
    };
    ...
    const persistedquery = '/graphql/execute.json/luma3/DynamicMediaTemplateByPath';
